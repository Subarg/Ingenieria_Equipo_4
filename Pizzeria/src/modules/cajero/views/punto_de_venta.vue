  ...
  <div class="flex h-screen bg-gray-900 text-white font-sans">
    <div class="w-2/3 p-6">
      ...
      <div class="flex space-x-4 mb-6 border-b border-gray-700">
        <button
          @click="posStore.cambiarCategoria('pizzas')"
          :class="
            categoriaActiva === 'pizzas'
              ? 'border-blue-500'
              : 'border-transparent'
          "
          class="py-2 px-4 border-b-2 font-semibold focus:outline-none"
        >
          Pizzas
        </button>
        <button
          @click="posStore.cambiarCategoria('bebidas')"
          :class="
        ...
        <button
          @click="posStore.cambiarCategoria('extras')"
          :class="
            categoriaActiva === 'extras'
              ? 'border-blue-500'
              : 'border-transparent'
          "
          class="py-2 px-4 border-b-2 font-semibold focus:outline-none"
    ...
    <div class="w-1/3 bg-gray-800 p-6 flex flex-col">
      ...
      <div class="flex-grow overflow-y-auto">
        ...
        <div
          v-for="(item, index) in ordenActual"
          :key="index"
          class="flex justify-between items-center mb-4 bg-gray-700 p-3 rounded-lg"
        >
          <div>
          ...
          <button
            @click="posStore.quitarDeOrden(index)"
      ...
      <div class="border-t border-gray-700 pt-6 mt-6">
        ...
        <button
          @click="posStore.cancelarOrden()"
          class="w-full bg-red-600 hover:bg-red-700 text-white font-bold py-2 rounded-lg mt-2"
        >
          CANCELAR ORDEN
        </button>
      </div>
